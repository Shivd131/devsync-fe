...
const Page = () => {
  ...
  return (
    <div className="h-screen w-screen bg-black flex">
      <div className="w-[20rem] bg-[#1b222b] h-screen flex flex-col justify-start items-center p-5 rounded-r-3xl">
          ...
          {sidebarOptions.map((option) => (
            <div
              ...
              className={`cursor-pointer h-12 flex items-center px-3 rounded-md ${
                activeOption === option.name ? "bg-cyan" : " bg-[#10141a] text-white"
              }`}
            >
